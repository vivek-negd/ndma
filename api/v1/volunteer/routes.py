...
from .views import VolunteerCreateAPIView, VolunteerBulkUploadAPIView, BulkUploadSessionListAPIView, OrganizationCoverageAPIView, VolunteerChoicesAPIView, VolunteerExportAPIView, VolunteerCoverageReportAPIView, DownloadBulkUploadTemplateAPIView
...
urlpatterns = [
    ...
    path("bulk-upload/sessions/", BulkUploadSessionListAPIView.as_view()),
    path("bulk-upload/template/", DownloadBulkUploadTemplateAPIView.as_view()),
...
# Safely query database (skip if table doesn't exist yet during migrations)
try:
    ...
    # Tables don't exist yet (during migrations) - skip for now
    pass